...
sudo systemsetup -settimezone "Australia/Brisbane" 2>/dev/null || true
...
# Note: -kill flag removed in modern macOS (was dangerous and no longer useful)
...
# Note: May not work on all macOS versions/configurations
